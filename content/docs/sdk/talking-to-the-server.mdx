...
Every request the SDK sends is the uniform envelope from [the message-passing spec](/spec/execution-model/message-passing) — a `kind`, a `head`, and operation-specific `data`:

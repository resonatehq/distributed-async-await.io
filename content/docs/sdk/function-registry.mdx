...
Next: [replay and deterministic execution](/sdk/replay-and-determinism) — what actually happens when that resumed worker re-runs a function whose steps are already half-recorded.

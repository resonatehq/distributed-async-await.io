...
Next: [the function registry and invocation surface](/sdk/function-registry) — how the developer's functions get names the server can dispatch to, and how an invocation becomes a targeted promise.

...
The canonical interaction in Distributed Async Await involves invoking and awaiting an asynchronous function remotely (see [Distributed Coordination Protocol](/specification/execution-model/coordination-protocol)).

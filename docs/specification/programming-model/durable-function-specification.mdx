...
The term *interruption* refers to a voluntary (system triggered) or involuntary (environment triggered) termination in mid execution. A voluntary termination is also refered to as an *interrupt*, an involuntary termination is also refered to as a *failure*.
